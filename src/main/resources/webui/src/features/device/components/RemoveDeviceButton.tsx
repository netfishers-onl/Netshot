...
export type RemoveDeviceButtonProps = PropsWithRenderItem<{
  devices: SimpleDevice[] | Device[]
}>

export default function RemoveDeviceButton(props: RemoveDeviceButtonProps) {
    ...
    const dialogRef = dialog.open(MUTATIONS.DEVICE_REMOVE, {
      ...
      description: (
        <>
          {isMultiple ? (
            <>
              {t("device.aboutToRemoveMultiple", {
