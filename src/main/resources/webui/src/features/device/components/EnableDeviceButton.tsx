...
export type EnableDeviceButtonProps = PropsWithRenderItem<{
  devices: SimpleDevice[] | Device[]
}>

export default function EnableDeviceButton(props: EnableDeviceButtonProps) {
      ...
      description: (
        <>
          {isMultiple ? (
            <>
              <Text>
                {t("device.aboutToEnableMultiple", {
