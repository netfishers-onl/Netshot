export const QUERIES = {
  ...
  DEVICE_FAMILY_LIST: "device-family-list",
  DEVICE_PART_NUMBER_LIST: "device-part-number-list",
...
export const MUTATIONS = {
  ...
  ADMIN_VAULT_INSTANCE_CREATE: ["mutation:admin:vaultinstance:create"],
  ADMIN_VAULT_INSTANCE_REMOVE: ["mutation:admin:vaultinstance:remove"],
  ADMIN_VAULT_INSTANCE_UPDATE: ["mutation:admin:vaultinstance:update"],
  ADMIN_VAULT_INSTANCE_TEST: ["mutation:admin:vaultinstance:test"],
  ...
  SCRIPT_VALIDATE: ["mutation:script:validate"],
